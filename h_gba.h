...
#define REG_DM1SAD      *(volatile unsigned long  *) 0x040000BC
#define REG_DM1DAD      *(volatile unsigned long  *) 0x040000C0
#define REG_DM1CNT_H    *(volatile unsigned short *) 0x040000C6
